...
<!--
Canonical plan imported from:
https://github.com/maxwelhelp/test2/blob/codex-full-agent-plan/simple_butterfly_matrix_v4_tape_lane/v4_6_loop_core/V4_6_4_PRIMITIVE_MATRIX_SCANNER_PLAN.md

Rule:
  This plan is the main design contract. Agents must read it before code changes.
-->
...
|---:|---|---|
| 17-57 | Purpose / short lock | what this plan targets |
| 59-110 | Terminology lock | layer/slot/action naming |
| 112-159 | Coverage checklist | all transferred ideas |
| 161-469 | Critical failure modes and required fixes | mandatory engineering fixes |
| 471-535 | Minimal vertical slice first | first empirical proof target |
| 537-599 | Full architecture diagram | forward data path |
| 601-643 | Closed-loop learning diagram | credit loop |
| 645-685 | PrimitiveMatrix | 5x5/10x10 action topology |
| 687-748 | HybridScanner | grid+semantic+usage+random scanner |
| 750-776 | ProjectionScanner | separate readable projections |
| 778-828 | Top-K low-rank simulation and mandatory influence | cheap thinking before acting |
| 830-871 | Projection gradient paths | how scanner/simulator learn |
| 873-925 | ActionMatrix execution | cell instruction execution |
| 927-953 | Gate separation | separate gates |
| 955-997 | Branching and variable output count | soft branch/merge slots |
| 999-1060 | Sequential layer specialization | layers listen and specialize |
| 1062-1115 | Input encoder honesty | Conv/no-conv and matrix frontend |
| 1117-1200 | Honest input curriculum | Teacher/Audit/Deploy |
| 1202-1246 | Mode-specific credit | teacher/audit/deploy credit buffers |
| 1248-1323 | Honesty audits | honesty tests |
| 1325-1409 | Universal insertion into neural network layers | standalone and plug-in modes |
| 1411-1456 | TokenSlotAdapter for attention replacement | token-slot mapping and incremental decode |
| 1458-1507 | Transformer wrapper modes | after/before/replace attention |
| 1509-1536 | Loss staging | start with few losses |
| 1538-1570 | Losses and protections | loss list |
| 1572-1623 | Credit and ablation | credit levels |
| 1625-1694 | Reports required | artifacts and report fields |
| 1696-1761 | Implementation plan | staged implementation |
| 1763-1788 | What not to do | avoid shortcuts |
| 1790-1849 | Evaluation plan | comparisons and metrics |
| 1851-1898 | Acceptance rules | success criteria |
| 1900-1933 | Current conclusion | locked direction |

---

## Purpose / short lock

This file is the corrected architecture plan for the next architecture after v4.6.3.

It covers two targets:

```text
1. standalone experiments now:
   synthetic known-program tests
...
Use these names in code, reports, commits, and docs.
...
slots = 4
PrimitiveMatrix = 5x5
top_k = 4 for normal plan, top_k=25 allowed for first debug to avoid candidate cutoff
sim_rank = 8 or 16
...
source_slot_embedding
target_slot_embedding
source-target address features
layer context
memory stats
