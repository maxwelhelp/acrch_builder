...
ADAPT_CHOICE_BOOST="${ADAPT_CHOICE_BOOST:-1.5}"
ADAPT_CELL_SHARPNESS="${ADAPT_CELL_SHARPNESS:-1.5}"
ADAPT_SHARPNESS="${ADAPT_SHARPNESS:-0.08}"
ADAPT_TOP_SHARE_FLOOR="${ADAPT_TOP_SHARE_FLOOR:-0.55}"
ADAPT_CHOICE_FLOOR="${ADAPT_CHOICE_FLOOR:-0.45}"
TARGET_ACTIVE_CELLS="${TARGET_ACTIVE_CELLS:-3.0}"
